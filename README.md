...
The fallback is loading the block regularly with the page load, returning the
cached block content if the page is cached.
...
This module uses the awesome, easy-to-use [htmx](https://htmx.org) library.
...
Bugs and Feature requests should be reported in the [Issue Queue](https://github.com/backdrop-contrib/ajaxblocks/issues).
